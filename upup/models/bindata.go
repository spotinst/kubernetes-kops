...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
      - name: dns-controller
        image: kope/dns-controller:1.18.3
        command:
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
      - name: kops-controller
        image: kope/kops-controller:1.18.3
        volumeMounts:
        ...
        - name: CILIUM_WAIT_BPF_MOUNT
          valueFrom:
            configMapKeyRef:
              ...
              name: cilium-config
              optional: true
        image: "docker.io/cilium/cilium:{{- or .Version "v1.7.12" }}"
...
{{ end }}
        ...
        - name: KUBERNETES_SERVICE_PORT
          value: "443"
{{ with .Networking.Cilium }}
        image: "docker.io/cilium/operator:{{- if eq .Version "" -}}v1.7.12{{- else -}}{{ .Version }}{{- end -}}"
        imagePullPolicy: IfNotPresent
        name: cilium-operator
        {{ if .EnablePrometheusMetrics }}
        ports:
      ...
      containers:
        - name: weave
          ...
          env:
            ...
            {{- end }}
          image: 'weaveworks/weave-kube:{{ or .Networking.Weave.Version "2.6.5" }}'
          ports:
            - name: metrics
              containerPort: 6782
          readinessProbe:
        ...
        - name: weave-npc
          env:
            ...
            {{- end }}
          image: 'weaveworks/weave-npc:{{ or .Networking.Weave.Version "2.6.5" }}'
          ports:
            - name: metrics
              containerPort: 6781
          resources:
